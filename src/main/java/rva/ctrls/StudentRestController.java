...
public class StudentRestController {
	...
	@ApiOperation(value="Vraća studenta na osnovu prosledjenog ID-ja iz baze podataka")
	public Student getStudent(@PathVariable("id") Integer id) {
		return studentRepository.getOne(id);
	}
	@GetMapping("studentGrupaID/{id}")
	@ApiOperation(value="Vraća kolekciju studenata na osnovu prosledjenog ID-ja iz baze podataka")
...
//	@GetMapping("studentBrIndeksa/{brojIndeksa}")
//	public Collection<Student> getStudentByBroj_indeksa(@PathVariable("brojIndeksa") String brojIndeksa){
//		return studentRepository.findByBrojIndeksaContainingIgnoreCase(brojIndeksa);
//	}
	
	@GetMapping("studentPoId/{id}")
	@ApiOperation(value="Vraća kolekciju svih studenata sa manjim ID-jem od prosledjenog iz baze podataka")
